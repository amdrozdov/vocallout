#!/usr/bin/env python3
"""
Monkey patched code from https://github.com/ufal/whisper_streaming
for realtime asr demos
"""
import sys
import numpy as np
import librosa  
...
def add_shared_args(parser):
    ...
    parser.add_argument('--model', type=str, default='large-v2',help="Name size of the Whisper model to use (default: large-v2). The model is automatically downloaded from the model hub if not present in model cache dir.")
